...
<?php
		...
		if($num_rows==1) {
			...
			echo "</tr>" ;
			echo "<tr>" ;
			echo "<td>Designation</td> <td>$designation</td>" ;
			echo "</tr>" ;
			echo "<tr>" ;
			echo "<td>Department</td> <td>$department</td>" ;
			echo "</tr>" ;
			echo "<tr>" ;
		...
		if($_SESSION['username']==$username) {
			echo "<ul><li><a href='edit_professor_profile.php' class='btn btn-primary btn-sm'>Edit Profile</a></li>" ;
