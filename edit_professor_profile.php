...
<?php
			...
			$query = "select * from professor_profile where username='$username'" ;
			...
			if($num_rows==1) {
				...
				$str = "<form>
    				...
    				<input name='userfile' onchange='upload_picture(this.form)' type='file' required/>
					</form>" ;
				echo "<div id='profile' class='clearfix'>" ;
				echo "<div id='picture'><div id='img' class='clearfix'><img src='$picture'/></div>$str</div>" ;
				echo "<div id='info'><form action='edit_professor_profile.php' method='POST'>" ;
				...
				echo "</tr>" ;
				echo "<tr>" ;
				echo "<td>Designation</td> <td><input type='text' name='designation' value='$designation'/> </td>" ;
				echo "</tr>" ;
				echo "<tr>" ;
				echo "<td>Email id</td> <td><input type='text' name='email' value='$email'/></td>" ;
				echo "</tr>" ;
				echo "<tr>" ;
				echo "<td>Department</td> <td><input type='text' name='department' value='$department'/></td>" ;
				echo "</tr>" ;
				echo "<tr>" ;
			...
			extract($_POST) ;
			$username = $_SESSION['username'] ;
			$query = "UPDATE `professor_profile` SET `firstname`='$firstname',`lastname`='$lastname',`department`='department',`email`='$email',`designation`='$designation',`about`='$about',`address`='$address', `phone_no`=$phone_no WHERE username='$username' "; 
